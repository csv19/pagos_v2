export const environment = {
  ...
  SERVER2: 'https://api_v2.test/v2',
  //MODULE
  API_MODULE: 'https://dashboard.test/v1/module',
  API_DOCUMENT: 'https://dashboard.test/v1/document',
  API_DASHBOARD_DOCUMENT: 'https://dashboard.test/v1/search/person',
  ...
  API_DNI: 'https://dashboard.test/v1/reniec',
  API_CARNET: 'https://dashboard.test/v1/carnet',
  API_RUC:'https://dashboard.test/v1/ruc',
